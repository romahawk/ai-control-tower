    ...
    <header className="h-14 flex items-center gap-4 px-6 border-b border-border bg-card/50 flex-shrink-0">
      ...
      <div className="flex-1 max-w-xl mx-auto">
        ...
        >
          ...
          <span className="flex-1 text-left text-sm">Search prompts, contexts, tools...</span>
          <div className="flex items-center gap-1">
            <kbd className="text-[10px] bg-surface-raised px-1.5 py-0.5 rounded border border-border font-mono">⌘</kbd>
            <kbd className="text-[10px] bg-surface-raised px-1.5 py-0.5 rounded border border-border font-mono">K</kbd>
          </div>
        </button>
      </div>
